...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="flow_check" namespace="/" method="post">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					<tr>
						<td><s:a action="downloadApplyFile?applyId=%{applyId}" style="text-decoration: underline">[点击下载申请的文档]</s:a></td>
					</tr>
                </table>
            </div>
        </div>
        ...
        <div id="InputDetailBar" style="float:none">
			...
			<s:hidden id="ispass" name="isPass" value="true"></s:hidden>
			<input type="image" src="${pageContext.request.contextPath}/style/blue/images/button/agree.png"/>
			<input type="image" onclick="$('#ispass').val(false)" src="${pageContext.request.contextPath}/style/blue/images/button/disagree.png"/>
