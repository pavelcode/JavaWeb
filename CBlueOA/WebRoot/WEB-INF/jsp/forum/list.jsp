		...
		<div class="ForumPageTableBorder" style="margin-top: 25px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr align="center" valign="middle">
					...
					<td width="80" class="ForumPageTableTitle">回复数</td>
				...
				<s:iterator value="forumManages" var="forum">
					...
					<td class="ForumPageTableDataLine">
						<ul class="ForumPageTopicUl">
							<li class="ForumPageTopic">
							  <s:a cssClass="ForumPageTopic" action="forum_show?id=%{id}">${forum.name}</s:a>
							</li>
							<li class="ForumPageTopicMemo">${forum.description}</li>
						</ul>
					</td>
					<td class="ForumPageTableDataLine"><b>${forum.themeCount}</b></td>
					<td class="ForumPageTableDataLine"><b>${forum.replyCount}</b></td>
					<td class="ForumPageTableDataLine">
						<ul class="ForumPageTopicUl">
							<li><font color="#444444">┌ 主题：</font> 
								<a class="ForumTitle" href="${pageContext.request.contextPath}/BBS_Topic/topicShow.html">${forum.lastTheme.title}</a>
							</li>
							<li><font color="#444444">├ 作者：</font> ${forum.lastTheme.author.name}</li>
							<li><font color="#444444">└ 时间：</font> ${forum.lastTheme.postTime}</li>
						</ul>
					</td>
					<td width="3"></td>
				</tr>
