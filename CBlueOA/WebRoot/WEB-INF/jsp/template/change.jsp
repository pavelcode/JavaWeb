...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="template_%{id==null?'add':'update'}" namespace="/" method="post" enctype="multipart/form-data">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr>
                        <td>所用流程</td>
                        <td><!-- <select class="SelectStyle" name="">
							...
							<s:select list="processDefinitions" name="processDefinitionKey" cssClass="SelectStyle" listKey="key" listValue="key"></s:select>
							*
						</td>
                    </tr>
                </table>
